...
#define MY_PLATFORM_UNIX 1
#elif defined(_POSIX_VERSION)
#define MY_PLATFORM_POSIX 1
#elif __APPLE__
#define MY_PLATFORM_APPLE 1
#include <TargetConditionals.h>
#if TARGET_IPHONE_SIMULATOR
#define MY_PLATFORM_IOS 1
#define MY_PLATFORM_IOS_SIMULATOR 1
...
#define MY_INLINE __attribute__((always_inline)) inline
